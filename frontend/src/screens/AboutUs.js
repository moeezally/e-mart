...
const AboutUs = () => {
  return (
    ...
    <Col md={4}>
        <Card.Img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" variant='top' style={{width:225,height:200,
