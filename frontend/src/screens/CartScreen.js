...
import { addProductToCart,addRentToCart, removeFromCart } from '../actions/cartActions'
...
const CartScreen = ({ match, location, history }) => {
  ...
  if (productId) {
    if (type === 'product')
        ...
        dispatch(addRentToCart(productId, qty))
}
}, [dispatch, productId, qty])
                      ...
                      onChange={(e) =>
                        ...
                        dispatch(
                          type === 'product' ?
                              addProductToCart(item.product, Number(e.target.value))
                              :
                              addRentToCart(item.product, Number(e.target.value))
                      )
